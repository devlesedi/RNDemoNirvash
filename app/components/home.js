...
var alicia = require('../images/khumo.jpg')
...
export default class Home extends Component {
  ...
  render() {
    return (
      <Image style={styles.column} source={require('../images/misskay_back.jpg')} resizeMode="cover" >
          <Nav {...this.props} />
      <SndNav {...this.props} />
    ...
    shadowOffset: {
      ...
      <EachConvo username="@principessa" name="Khumo Kgwaadira" image = {alicia} />
